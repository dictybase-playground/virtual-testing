...
<Image src={current} style={{ width: "100%", height: "50%" }} />
...
<center>
  <Image src={useIntersectionObserver} height={750} width={600} />
</center>
...
_Open your browser dev tools to see how these list items are rendered to the DOM._
