...
<div>
  This hook creates a new <em>IntersectionObserver</em> that observes an
  observer ref. It returns an object with two properties:
  <ul>
    <li>
      A{" "}
...
<center>
  <Image src={useIntersectionObserver} height={750} width={520} />
</center>
